...
export default function CirculationManagement() {
  ...
  const formatDate = (dateArray: number[] | null | undefined) => {
    ...
    // Nếu backend trả về date lệch 1 ngày (do timezone), cộng thêm 1 ngày
    const [year, month, day] = dateArray;
    const date = new Date(year, month - 1, day + 1); // Cộng 1 ngày để fix timezone issue
