...
import UserCard from "../components/layoutUser/UserFloatingPanel";
import {
  getAllBooks, getAllEbooks, getAllCategories, getAllTags, getAllAuthors,
  getBooksByAuthorId, searchBooksByTitle, getBooksByCategoryAndTags, getMyInfo
} from "../api/apiService";
    ...
    <div className="user-home-page">
      <UserCard
        user={{
          ...
          role: currentUser?.role || "Độc giả",
          avatar: currentUser?.avatar,
          dateOfBirth: currentUser?.birthDate,
          address: currentUser?.address,
        }}
        onBorrowSlipClick={() => { setBorrowFormOpen(true); setSelectedBookId(null); }}
      />
            ...
            <div className="user-books-grid">
              {displayBooks.length > 0 ? (
                displayBooks.map((book) => {
                  ...
                  const bookData = isEbook ? (((book as any)?.book) ?? (book as any)) : book;
